...
if __name__ == '__main__':
    ...
    save_model_path = f'/NAS/user_data/user/ld258/output/work_dirs/{data_name}/' +model_config + '_freeze_' + str(freeze) + '_pretrained_' + str(pretrained) + '_baseline_' +  os.sep
